...
; Function Attrs: noinline nounwind optnone ssp uwtable
define i32 @print_float(float %0) #0 {
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define i32 @print_string(i8* %0) #0 {
  %2 = alloca i8*, align 8
...
define i32 @read_int() #0 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i64 0, i64 0), i32* %1)
...
define i32 @read_bool() #0 {
  ...
  %2 = alloca i8*, align 8
  %3 = load i8*, i8** %2, align 8
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i64 0, i64 0), i8* %3)
  %5 = load i8*, i8** %2, align 8
  %6 = call i32 @strcmp(i8* %5, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.7, i64 0, i64 0))
  %7 = icmp ne i32 %6, 0
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define float @read_float() #0 {
  %1 = alloca float, align 4
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i64 0, i64 0), float* %1)
